...
[CodePipeline - Build and Deploy Lambda]() - Create CodePipeline (manual) / Write **buildspec.yaml** for CodeBuild / Add versioning for images / Push to ecr / Deploying lambda using CloudFormation Stack with parameters and template file / Configure API Gateway (GET&POST requests).
